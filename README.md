...
- **UI/UX Design** – Wireframes and prototypes using Figma
- **Version Control** – Git-based collaboration and repository management
- **Problem Solving** – Debugging, optimization, and clean architecture
- **Continuous Learning** – Exploring new tools and best practices
- **Team Collaboration** – Clear communication and efficient delivery
...
> Java-based application following Domain-Driven Design (DDD) principles.

🔹 **Healthcare Management System**  
[🔗 View Repository](https://github.com/zaid-xt/HealthcareManagementSystem)  
> Full-stack TypeScript system with modular backend architecture.
